...
namespace TheatreCMS3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Log in as comment moderator from a button click
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> LoginCommentModerator(string returnUrl)
        { 
            var result = await SignInManager.PasswordSignInAsync("Admin", "Admin123!", true, shouldLockout: false);
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal(returnUrl);
